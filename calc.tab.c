...
#line 205 "calc.tab.c" /* yacc.c:339  */
...
#line 279 "calc.tab.c" /* yacc.c:355  */
};
...
#line 294 "calc.tab.c" /* yacc.c:358  */
...
{
       0,   167,   167,   170,   171,   174,   179,   184,   202,   210,
     238,   241,   245,   249
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_MAIN", "TOK_OPENCURL",
  "TOK_CLOSECURL", "TOK_PRINTVAR", "TOK_PRINTLN", "TOK_INT_KEYWORD",
  "TOK_FLOAT_KEYWORD", "TOK_NUM_INT", "TOK_NUM_FLOAT", "TOK_IDENTIFIER",
  "TOK_SEMICOLON", "TOK_ADD", "TOK_MUL", "TOK_EQUAL", "$accept", "prog",
...
#line 174 "calc.y" /* yacc.c:1646  */
    {
                                          ...
                                          symbol_table_pointer_ref= insert(symbol_table_pointer_ref,(yyvsp[0].string),0,9999,9999.99);
...
#line 179 "calc.y" /* yacc.c:1646  */
    {
                                        // fprintf(stdout,"\n\n\n\nDebugging,TOK_FLOAT_KEYWORD in parser %s\n", $2);
                                          symbol_table_pointer_ref= insert(symbol_table_pointer_ref,(yyvsp[0].string),1,9999,9999.99);
...
#line 184 "calc.y" /* yacc.c:1646  */
    {
                                          ...
                                          SMT id_in_smt = lookup(symbol_table_pointer_ref,(yyvsp[-2].string));
                                          if(id_in_smt==NULL){yyerror("symbol not found error");}
                                          if(id_in_smt->type!=(yyvsp[0].struct_expr).type){yyerror("Type Error when assigning expr to ID");}

                                          update(symbol_table_pointer_ref,(yyvsp[-2].string),(yyvsp[0].struct_expr).ival,(yyvsp[0].struct_expr).fval);
                                           if(id_in_smt->type==0){
...
#line 202 "calc.y" /* yacc.c:1646  */
    {
                                    //fprintf(stdout, "TOK_PRINTVAR the value is %s\n", $2);
                                     print(symbol_table_pointer_ref,(yyvsp[0].string));
...
#line 210 "calc.y" /* yacc.c:1646  */
    {
        ...
        if((yyvsp[-2].struct_expr).type==(yyvsp[0].struct_expr).type){
            (yyval.struct_expr).type=(yyvsp[-2].struct_expr).type;
            if((yyvsp[-2].struct_expr).type==0){

                (yyval.struct_expr).ival = (yyvsp[-2].struct_expr).ival + (yyvsp[0].struct_expr).ival;
            fprintf(stdout," Adding two values(int)  %d and  %d ---\n",(yyvsp[-2].struct_expr).ival,(yyvsp[0].struct_expr).ival);
                
            }
            else if((yyvsp[-2].struct_expr).type==1){

                (yyval.struct_expr).fval = (yyvsp[-2].struct_expr).fval + (yyvsp[0].struct_expr).fval;
            fprintf(stdout," Adding two values(float)  %f and  %f ---\n",(yyvsp[-2].struct_expr).fval,(yyvsp[0].struct_expr).fval);
...
#line 241 "calc.y" /* yacc.c:1646  */
    {
                ...
                (yyval.struct_expr).ival = (yyvsp[0].int_val);
              }
...
#line 245 "calc.y" /* yacc.c:1646  */
    { fprintf(stdout,"\n\n\n\e rule applied: E is float_int %f\n", (yyvsp[0].float_val)); 
                        (yyval.struct_expr).type=1;
                        (yyval.struct_expr).fval = (yyvsp[0].float_val); 
                    }
...
#line 250 "calc.y" /* yacc.c:1646  */
    {
                    (yyval.struct_expr).id_name = (yyvsp[0].string);
                    SMT id_in_smt = lookup(symbol_table_pointer_ref,(yyvsp[0].string));
                    if(id_in_smt==NULL){
                        ...
                        yyerror("Symbol not found error");
                            ...
                            (yyval.struct_expr).type= id_in_smt->type;
                            if((id_in_smt->type)==0)
                                    {


                                        (yyval.struct_expr).ival = id_in_smt->ival;
                                       // $$.id_name=id_in_smt->id_name;
                                        printf("copied id ival to expr\n");
                                    }
                            if((id_in_smt->type)==1)
                            {
                                        (yyval.struct_expr).fval = id_in_smt->fval;
                                       // $$.id_name=id_in_smt->id_name;
